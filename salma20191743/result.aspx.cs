...
namespace salma20191743
{
    public partial class result : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string strInsert = String.Format("INSERT INTO Results VALUES('{0}','{1}','{2}','{3}','{4}')", TXT_F.Text, TXT_L.Text, TXT_DOB.Text, rbl_Gender.SelectedValue, TXT_NUM.Text, TXT_EMAIL.Text, DropDownList1.SelectedValue, TXT_USERNAME.Text, TXT_PASS.Text);
